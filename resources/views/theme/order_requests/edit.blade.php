        ...
        <div id="kt_toolbar_container1" class="container-fluid d-flex flex-stack vehicle-info-stickey-wrapper">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <div class="d-flex flex-wrap fw-bold fs-6 pe-2">
                    <span class="d-flex align-items-center text-gray-400 text-hover-primary me-5 text-gray-800 text-hover-primary fw-bolder">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="vehicle_type_id" aria-label="Select a vehicle" data-control="select2"
                                        ...
                                        <option value="{{ $vehicle_type->id }}" @if ($OrderRequest->vehicle_type_id==$vehicle_type->id)
                                            {{'selected'}}
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vin_no"
                                        ...
                                        placeholder="VIN Number" value='{{$OrderRequest->vin_no}}'/>
                                    @error('vin_no')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vehicle_year"
                                        ...
                                        placeholder="Vehicle Year" value='{{$OrderRequest->vehicle_year}}'/>
                                    @error('vehicle_year')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vehicle_make"
                                        ...
                                        placeholder="Vehicle Make" value='{{$OrderRequest->vehicle_make}}'/>
                                    @error('vehicle_make')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vehicle_model"
                                        ...
                                        placeholder="Vehicle Model" value='{{$OrderRequest->vehicle_model}}'/>
                                    @error('vehicle_model')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vehicle_mileage"
                                        ...
                                        placeholder="Vehicle Mileage" value='{{$OrderRequest->vehicle_mileage}}'/>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vehicle_wholesale_value"
                                        ...
                                        placeholder="Vehicle Wholesale Value" value='{{$OrderRequest->vehicle_wholesale_value}}'/>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="vehicle_retail_value"
                                        ...
                                        placeholder="Vehicle Retail Value" value='{{$OrderRequest->vehicle_retail_value}}'/>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="inspector_id" aria-label="Select a vehicle" data-control="select2"
                                        ...
                                        <option value="{{$Inspector->id}}" @if ($OrderRequest->inspector_id==$Inspector->id)
                                            {{'selected'}}
