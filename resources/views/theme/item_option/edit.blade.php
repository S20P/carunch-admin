        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Edit Item</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="add_item_form" class="form" method="post" action="{{route('inspection-item-option.update',$item_option->id)}}">
                        @csrf
                        @method('PUT')
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="inspection_location_id" id="location_id" aria-label="Select a Location" data-control="select2" data-placeholder="Select a Location..." class="form-select form-select-solid form-select-lg fw-bold">
                                        ...
                                        <option value="{{ $location->id }}" @if($location->id === $item_option->inspection_location_id) {{'selected'}} @endif >{{ $location->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <select name="inspection_type_id" id="inspection_type_id" aria-label="Select a Type" data-control="select2" data-placeholder="Select a Type..." class="form-select form-select-solid form-select-lg fw-bold">
                                        <option value="">Select a Type...</option>
                                        @foreach($types as $type)
                                            @if($item_option->inspection_type_id == $type->id)
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="inspection_item_id" id="inspection_item_id" aria-label="Select Inspection Item" data-control="select2" data-placeholder="Select Inspection Item..." class="form-select form-select-solid form-select-lg fw-bold">
                                        ...
                                        @foreach($items as $item)
                                            @if($item_option->inspection_item_id == $item->id)
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="status" aria-label="Select a Status" data-control="select2" data-placeholder="Select a Status..." class="form-select form-select-solid form-select-lg fw-bold">
                                        <option value="">Select a Status...</option>
                                            <option value="true" @if($item_option->status === true) {{'selected'}} @endif>Active</option>
                                            <option value="false" @if($item_option->status === false) {{'selected'}} @endif>De-Active</option>
                                    </select>
                                </div>
                                <!--end::Col-->
                            </div>
                                        ...
                                        <div data-repeater-item class='option-item-wrap'>
                                            <div class="form-group row mb-5">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="Input Label" value='{{$attr->label}}'/>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            @php
                                                if($attr->label_type=='checkbox')
                                                {
                                                    ...
                                                    $loption=$attr->label_options;
                                                    $lo=json_decode($loption);
                                                    $option_label1=$lo->option_label;
                                                    $option_value1=$lo->option_value;
                                                    $option_label2=$lo->option_label2;
                                                    $option_value2=$lo->option_value2;
                                                }
                                                else
                                                {
                                            ...
                                            <div class="radio-option" {{$sty}}>
                                                <div class="form-group row mb-5">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label">Input Label Name</label>
                                                        <input type="text" name="option_label" class="form-control form-control-lg form-control-solid" placeholder="Input Label" value='{{$option_label1}}' />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Input Label Value</label>
                                                        <input type="text" name="option_value" class="form-control form-control-lg form-control-solid" placeholder="Input Label" value='{{$option_value1}}' />
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-5">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label">Input Label Name</label>
                                                        <input type="text" name="option_label2" class="form-control form-control-lg form-control-solid" placeholder="Input Label" value='{{$option_label2}}' />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Input Label Value</label>
                                                        <input type="text" name="option_value2" class="form-control form-control-lg form-control-solid" placeholder="Input Label" value='{{$option_value2}}' />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script src="{{asset('js/custom_js/item_option_edit.js')}}"></script>
@endsection